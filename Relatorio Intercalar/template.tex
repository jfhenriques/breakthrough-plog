...
\item Uma peça pode ser capturada (substituída) se se encontrar em frente ao adversário e na sua diagonal. A captura não é obrigatória nem encadeada como nas damas.

\begin{figure}[H]
\begin{center}
\subfloat[Possibilidades]{\includegraphics[scale=0.5]{fig2a.png}\label{fig:2a}}\hspace{10px}
